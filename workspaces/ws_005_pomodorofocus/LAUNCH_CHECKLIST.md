# Launch Checklist — Pomodoro Focus Timer
...
| Package name | `com.appfactory.pomodorofocus` |
...
| Field | Value |
|-------|-------|
| Privacy policy URL | `https://qizhangumich.github.io/app-privacy/pomodorofocus.html` |
| Developer contact email | `developer_apple@linkwave.one` |
| Developer website | `https://qizhangumich.github.io/app-privacy/pomodorofocus.html` (or LinkWave site if available) |
...
| Field | Value |
|-------|-------|
| URL | `https://qizhangumich.github.io/app-privacy/pomodorofocus.html` |
...
```bash
python scripts/play_release.py --submit --only ws_005_pomodorofocus
```
...
`workspaces/ws_005_pomodorofocus/android/app/build.gradle.kts` and run:

```bash
python scripts/play_release.py --build --submit --only ws_005_pomodorofocus
```
