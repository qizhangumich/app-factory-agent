# Launch Checklist — QR & Barcode Scanner+
...
| Package name | `com.appfactory.qrbarcodescanner` |
...
| Field | Value |
|-------|-------|
| Privacy policy URL | `https://qizhangumich.github.io/app-privacy/qrbarcodescanner.html` |
| Developer contact email | `developer_apple@linkwave.one` |
| Developer website | `https://qizhangumich.github.io/app-privacy/qrbarcodescanner.html` (or LinkWave site if available) |
...
| Field | Value |
|-------|-------|
| URL | `https://qizhangumich.github.io/app-privacy/qrbarcodescanner.html` |
...
```bash
python scripts/play_release.py --submit --only ws_004_qrbarcodescanner
```
...
`workspaces/ws_004_qrbarcodescanner/android/app/build.gradle.kts` and run:

```bash
python scripts/play_release.py --build --submit --only ws_004_qrbarcodescanner
```
